  ...
  <div class="shell on-dark">
    <div class="split split--wide-left split--top">
      <div data-reveal>
        ...
        <h2 class="display-lg">Un club recrute, la famille doit être installée en trois jours.</h2>
      ...
      <div data-reveal>
        <div class="stats stats--2 stats--dark">
          <div class="stat"><span class="stat__k">3 j</span><span class="stat__v">Délai visé entre la demande et la remise des clés</span></div>
