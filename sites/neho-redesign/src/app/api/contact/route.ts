...
/**
 * Traite le formulaire de contact. Sans RESEND_API_KEY/CONTACT_TO configurés,
 * la demande est validée et journalisée côté serveur mais aucun e-mail
 * n'est réellement envoyé — voir .env.example et README.md.
 */
    ...
    try {
      const res = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          subject: `[Ného Concept — démo] ${safeData.subject}`,
