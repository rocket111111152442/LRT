...
def json_ld(brand, prefix):
    return (
        ...
        f'"url":"{SITE_URL}/","email":"{CONSULTING_MAIL}",'
...
FONTS = {"consulting": FONTS_CONSULTING}
...
def main():
    import content_consulting, content_consulting_pages
