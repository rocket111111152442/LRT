    ...
    proAccount: {
      ...
      async create(args: { data: Dict }) {
        ...
        const proAccount = {
          ...
          qualireparApiKey: data.qualireparApiKey ?? null,
    ...
    repair: {
      ...
      async create(args: { data: Dict; select?: Dict }) {
        ...
        const repair = {
          ...
          qualireparBrandId: args.data.qualireparBrandId ?? null,
          qualireparProductId: args.data.qualireparProductId ?? null,
          qualireparSymptom: args.data.qualireparSymptom ?? null,
          qualireparRequestId: args.data.qualireparRequestId ?? null,
          qualireparStatus: args.data.qualireparStatus ?? null,
