...
export const metadata: Metadata = {
  ...
  description:
    "Qoravo est le logiciel tout-en-un des réparateurs (smartphone, PC, console) : QR code de suivi client, devis, statuts, agenda, stock, comptabilité et emails automatiques. Essai gratuit de 7 jours, 89,99 €/an, sans engagement.",
  keywords: [
...
const steps = [
  { n: "1", title: "Créez votre compte", text: "Trois informations suffisent. Essai gratuit de 7 jours, sans carte bancaire pour démarrer." },
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl rounded-3xl bg-slate-950 px-6 py-12 text-center text-white">
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
            Testez Qoravo gratuitement pendant 7 jours.
          </h2>
