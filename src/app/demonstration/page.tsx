    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <header className="border-b border-slate-200 bg-white px-4 py-4 sm:px-6">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          <QoravoLogo />
          <Link href="/pro/inscription" className="q-btn q-btn-primary text-sm">Essayer 14 jours <ArrowRight className="h-4 w-4" /></Link>
        </div>
      </header>
      ...
      <section className="border-t border-slate-200 bg-white px-4 py-14 sm:px-6">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_0.8fr]">
          ...
          <div className="grid content-center gap-4 rounded-lg bg-slate-950 p-6 text-white">
            ...
            <h2 className="text-3xl font-extrabold">14 jours pour l&apos;essayer dans votre atelier.</h2>
