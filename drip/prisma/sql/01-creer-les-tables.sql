...
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "role" "Role" NOT NULL DEFAULT 'CUSTOMER';
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "acceptsMarketing" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "sessionsValidFrom" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE "Address" ADD COLUMN IF NOT EXISTS "country" TEXT NOT NULL DEFAULT 'FR';
...
ALTER TABLE "Category" ADD COLUMN IF NOT EXISTS "position" INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "color" TEXT;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "colorHex" TEXT;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "size" TEXT;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "sku" TEXT;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "podVariantId" TEXT;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "cost" INTEGER;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "available" BOOLEAN NOT NULL DEFAULT true;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "position" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Variant" ADD COLUMN IF NOT EXISTS "imageUrl" TEXT;
...
ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "shipping" INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "podOrderId" TEXT;
...
ALTER TABLE "OrderItem" ADD COLUMN IF NOT EXISTS "costPrice" INTEGER;
ALTER TABLE "OrderItem" ADD COLUMN IF NOT EXISTS "imageUrl" TEXT;
ALTER TABLE "OrderItem" ADD COLUMN IF NOT EXISTS "podProductId" TEXT;
ALTER TABLE "OrderItem" ADD COLUMN IF NOT EXISTS "podVariantId" TEXT;
...
ALTER TABLE "WishlistItem" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "Coupon" ADD COLUMN IF NOT EXISTS "type" "DiscountType" NOT NULL DEFAULT 'PERCENT';
ALTER TABLE "Coupon" ADD COLUMN IF NOT EXISTS "minSubtotal" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Coupon" ADD COLUMN IF NOT EXISTS "maxUses" INTEGER;
ALTER TABLE "Coupon" ADD COLUMN IF NOT EXISTS "uses" INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE "NewsletterSubscriber" ADD COLUMN IF NOT EXISTS "source" TEXT;
ALTER TABLE "NewsletterSubscriber" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "ContactMessage" ADD COLUMN IF NOT EXISTS "handled" BOOLEAN NOT NULL DEFAULT false;
