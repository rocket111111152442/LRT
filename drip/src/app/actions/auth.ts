...
import { runFormAction, type FormState } from "@/lib/formAction";
import {
  createSession,
  destroySession,
  generateToken,
...
export async function registerAction(
  ...
  return runFormAction("création de compte", formData, async () => {
...
export async function loginAction(
  ...
  return runFormAction("connexion", formData, async () => {
...
export async function forgotPasswordAction(
  ...
  return runFormAction("mot de passe oublié", formData, async () => {
...
export async function resetPasswordAction(
  ...
  return runFormAction("réinitialisation du mot de passe", formData, async () => {
...
export async function updateProfileAction(
  ...
  return runFormAction("mise à jour du profil", formData, async () => {
...
export async function changePasswordAction(
  ...
  return runFormAction("changement de mot de passe", formData, async () => {
    const user = await getCurrentUser();
    if (!user) return { errors: { form: "Session expirée." } };
